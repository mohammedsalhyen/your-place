...
const ProfileNav = ({ user, open, basicData, setBasicData, bussinessData, setBussinessData }: any) => {
    return (
        <div>
            {
                open &&
                <div data-aos="fade-down" className={`absolute h-fit left-0 top-20 rounded-lg w-full xs:block sm:hidden`} >
