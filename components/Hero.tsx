...
const Hero = () => {
    ...
    return (
        <section className=' overflow-hidden xs:min-h-svh md:h-svh relative bg-[#f9f9f9]' id='hero'>
            <Navbar />
            <div className='main-prop max-container padding-container h-full  '>
                <div className='transition-all overflow-hidden flex justify-between md:flex-row xs:flex-col xs:justify-center xs:gap-20 items-center h-full'>
